  ...
  const testimonials = [
    {
      ...
      rating: 5,
      text: "My child has improved a lot after finishing school. Thank you very much Edukid.",
    },
    {
      id: 2,
      name: "Darlene Robertson",
      image: "/assets/robertson.png",
      rating: 5,
      text: "My child knows how to write very good essays. English ability is also much better. The cost is very cheap, so you should register. Thank you very much Edukid.",
    },
    {
      id: 3,
      name: "Dianne Russell",
      image: "/assets/russell.png",
      rating: 5,
      text: "My child has improved a lot after finishing school. Thank you very much Edukid.",
    },
    {
      ...
      rating: 5,
      text: "The mentorship program has been incredibly valuable for my academic growth.",
    },
  ];
                ...
                <div className="flex items-center mb-4">
                  <img 
                    ...
                    onError={(e) => {
                      ...
                      e.target.src = `https://via.placeholder.com/48?text=${testimonial.name.split(' ')[0][0]}`;
                    }}
                  />
                  <div>
